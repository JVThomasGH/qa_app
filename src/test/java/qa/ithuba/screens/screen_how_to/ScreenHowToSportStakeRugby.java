...
public class ScreenHowToSportStakeRugby extends HelperUtil {
...
//    @iOSXCUITFindBy (id = "")
    ...
    @AndroidFindBy(xpath = "//*[@class = 'android.view.View' and (@text = 'You can play the SPORTSTAKE RUGBY game by predicting outcomes of 10 predetermined rugby fixtures drawn from various league/tournaments and other identified professional sources across the globe.' or . = 'You can play the SPORTSTAKE RUGBY game by predicting outcomes of 10 predetermined rugby fixtures drawn from various league/tournaments and other identified professional sources across the globe.')]")
//    @iOSXCUITFindBy (id = "")
    private WebElementFacade textP1HowToSportStakeCricket;

    @AndroidFindBy(xpath = "//*[@class = 'android.view.View' and (@text = 'Obtain an applicable fixture list for the SPORTSTAKE RUGBY game and predict full time outcomes for each rugby matches featured in match list of 10.' or . = 'Obtain an applicable fixture list for the SPORTSTAKE RUGBY game and predict full time outcomes for each rugby matches featured in match list of 10.')]")
//    @iOSXCUITFindBy (id = "")
    private WebElementFacade textP2HowToSportStakeCricket;

    @AndroidFindBy(xpath = "//*[@class = 'android.view.View' and (@text = 'Mark your first time predictions in the applicable tick box for each relevant fixture.' or . = 'Mark your first time predictions in the applicable tick box for each relevant fixture.')]")
//    @iOSXCUITFindBy (id = "")
...
//    @iOSXCUITFindBy (id = "")
    ...
    public void verifyHowToSportStakeRugbyText() {
        Assert.assertEquals("You can play the SPORTSTAKE RUGBY game by predicting outcomes of 10 predetermined rugby fixtures drawn from various league/tournaments and other identified professional sources across the globe.", textP1HowToSportStakeCricket.getText());
        Assert.assertEquals("Obtain an applicable fixture list for the SPORTSTAKE RUGBY game and predict full time outcomes for each rugby matches featured in match list of 10.", textP2HowToSportStakeCricket.getText());
        Assert.assertEquals("Mark your first time predictions in the applicable tick box for each relevant fixture.", textP3HowToSportStakeCricket.getText());
